...
typedef StatusWord (*Transmitfn)(ByteArray apdu, ByteDynArray *resp);
...
public:
    ...
    void ReadATR(ByteDynArray &data);
    ...
    //Usati in PUK recover
    ByteDynArray GetModuleFromPubKey(ByteDynArray &data);
    ByteDynArray GetExpFromPubKey(ByteDynArray &data);
    void SignIntAuth(ByteArray &data, ByteDynArray &signedData);
    //
